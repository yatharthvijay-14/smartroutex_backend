...
public class PotholeService {
    ...
    public void seedInitialPotholesIfEmpty() {
        if (repository.count() == 0) {
            ...
            repository.save(new Pothole("Direct City Corridor (Pothole Zone A)", 25.1750, 75.8410, "HIGH", "15 cm", "10 mins ago", img1, "system"));
            repository.save(new Pothole("Aerodrome Circle Road (Pothole Zone B)", 25.1650, 75.8450, "HIGH", "12 cm", "25 mins ago", img2, "system"));
            repository.save(new Pothole("Rajeev Gandhi Nagar", 25.1600, 75.8700, "MEDIUM", "8 cm", "1 hour ago", img1, "system"));
            repository.save(new Pothole("Vigyan Nagar Flyover", 25.1810, 75.8390, "HIGH", "14 cm", "2 hours ago", img2, "system"));
            repository.save(new Pothole("Nayapura Heritage Road", 25.1820, 75.8400, "LOW", "5 cm", "4 hours ago", img1, "system"));
        }
    }
